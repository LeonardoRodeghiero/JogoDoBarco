...
def escolher_fundo_2Players(fundoSorteado):
    cor_score = ()
    
    if fundoSorteado == 2:
        fundo_surf = pygame.image.load('graficos/fundo/FundosDivididos/fundo2/fundo2.png').convert()
        fundo_surf = pygame.transform.scale(fundo_surf, (config.largura, config.altura))

        cor_score =  (64,64,64)

    if fundoSorteado == 3:
        fundo_surf = pygame.image.load('graficos/fundo/FundosDivididos/fundo3/fundo3.png').convert()
        fundo_surf = pygame.transform.scale(fundo_surf, (config.largura, config.altura))

        cor_score =  'white'

    if fundoSorteado == 4:
        fundo_surf = pygame.image.load('graficos/fundo/FundosDivididos/fundo4/fundo4.png').convert()
        fundo_surf = pygame.transform.scale(fundo_surf, (config.largura, config.altura)) 
    ...
    if fundoSorteado == 5:
        fundo_surf = pygame.image.load('graficos/fundo/FundosDivididos/fundo5/fundo5.png').convert()
        fundo_surf = pygame.transform.scale(fundo_surf, (config.largura, config.altura)) 
    ...
    if fundoSorteado == 6:
        fundo_surf = pygame.image.load('graficos/fundo/FundosDivididos/fundo6/fundo6.png').convert()
        fundo_surf = pygame.transform.scale(fundo_surf, (config.largura, config.altura))  
    ...
    if fundoSorteado == 7:
        fundo_surf = pygame.image.load('graficos/fundo/FundosDivididos/fundo7/fundo7.png').convert()
        fundo_surf = pygame.transform.scale(fundo_surf, (config.largura, config.altura))
